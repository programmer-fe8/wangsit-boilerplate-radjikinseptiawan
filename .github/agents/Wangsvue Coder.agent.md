...
tools:
  [
    ...
    'agent',
    'wangsvue-mcp/*',
    'figma-dev/get_design_context',
    'figma-dev/get_figjam',
    'figma-dev/get_metadata',
    'figma-dev/get_screenshot',
    'wangsvue-docs/get-example',
    'wangsvue-docs/get-sections',
    'wangsvue-docs/list-components',
    'wangsvue-docs/list-examples',
    'todo',
  ]
---
